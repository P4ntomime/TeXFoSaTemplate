...
\NewDocumentEnvironment{layout}{}{
    \int_new:N\l_my_numcols_int
 
    \dim_compare:nNnTF{\paperwidth}<{\paperheight}
    {
        % PORTRAIT LAYOUT
        \int_set:Nn\l_my_numcols_int {2} % default number of columns for portrait layout      
    ...
    {
        \int_set:Nn\l_my_numcols_int {3} % set number of columns for landscape layout
    }
    \begin{multicols*}{\int_use:N\l_my_numcols_int}
    \raggedcolumns%
