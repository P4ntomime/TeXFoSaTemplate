...
\newcommand\coloroncondition{\ifcoloranglebrackets\color{stringcolour}\fi}
...
\lstdefinestyle{cppstyle}{
    ...
    extendedchars=true,
    inputencoding=cp1252,
    morekeywords={final, override, enum, var},
    moredelim=**[directive][\coloranglebracketstrue]\#, % source: https://tex.stackexchange.com/questions/409859/listings-how-to-colorize-strings-between-angle-brackets 
